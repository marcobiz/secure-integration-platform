...
function New-ReleaseFixture {
    ...
    $manifest = [ordered]@{
        ...
        images = @(
            [ordered]@{ role = 'gateway'; reference = $gatewayReference; imageId = $GatewayImageId; versionLabel = $productVersion; revisionLabel = $ExpectedSourceCommit; sourceLabel = 'https://github.com/msala9/secure-integration-platform'; vendorLabel = 'ApoCert S.r.l.'; titleLabel = 'Secure Integration Platform Gateway'; licenseLabel = 'MPL-2.0' },
