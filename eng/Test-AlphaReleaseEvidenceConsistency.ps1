...
function New-SyntheticReleaseSet {
    ...
    $manifest = [ordered]@{
        schemaVersion = 2; product = 'SecureIntegrationPlatform'; version = $productVersion; sourceRevision = $sourceCommit; releaseChannel = 'public-technical-preview'; releaseClass = 'PUBLIC TECHNICAL PREVIEW'; distributionTarget = 'GitHub public prerelease v0.1.0-alpha.1'
