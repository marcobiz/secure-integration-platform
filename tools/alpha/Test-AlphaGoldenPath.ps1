...
function Test-NativeBoundedControlTransport {
    ...
    Assert-True ($quickstartText.IndexOf("'--max-filesize', '262144'", [StringComparison]::Ordinal) -ge 0)
    Assert-True ($quickstartText.IndexOf("'--cacert', '/run/m5-probe/ca.crt'", [StringComparison]::Ordinal) -ge 0)
