...
export const adminApi = {
  ...
  validateConnector: (definition: object) => api<{ valid: boolean; checksumSha256: string | null; issues: Array<{ code: string; location: string }> }>('/admin/api/v1/connectors:validate', { method: 'POST', body: JSON.stringify({ definition }) }),
