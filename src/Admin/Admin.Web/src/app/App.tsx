...
const GuidedOnboarding = lazy(() => import('../features/onboarding/GuidedOnboardingPage').then(value => ({ default: value.GuidedOnboardingPage })));

const Documentation = lazy(() => import('../features/documentation/DocumentationPage').then(value => ({ default: value.DocumentationPage })));

function CurrentPage() { return <Switch><Route path="/documentation" component={Documentation} /><Route exact path="/" component={Dashboard} /><Route path="/onboarding" component={GuidedOnboarding} /><Route path="/tenants" component={Tenants} /><Route path="/applications" component={Applications} /><Route path="/installations" component={Installations} /><Route path="/connectors" component={Connectors} /><Route path="/bindings" component={Bindings} /><Route path="/grants" component={Grants} /><Route path="/approvals" component={Approvals} /><Route path="/access" component={Access} /><Route path="/audit" render={() => <TenantData kind="audit" />} /><Route path="/health" component={Health} /><Route component={Dashboard} /></Switch>; }
