...
function CurrentPage() { const path = window.location.pathname.replace(/^\/admin\/?/, ''); switch (path) { case 'tenants': return <Tenants />; case 'applications': return <Applications />; case 'installations': return <Installations />; case 'connectors': return <Connectors />; case 'bindings': return <Bindings />; case 'grants': return <TenantData kind="grants" />; case 'approvals': return <Approvals />; case 'audit': return <TenantData kind="audit" />; case 'health': return <Health />; default: return <Dashboard />; } }
