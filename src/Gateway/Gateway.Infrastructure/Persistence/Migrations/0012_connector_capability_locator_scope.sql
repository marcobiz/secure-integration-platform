-- Wave 1 capability completion. Extend the least-privilege runtime locator only to
-- exact server-owned inputs and signing identities declared by the granted Published operation.
        ...
        WHERE operation ->> 'operationId' = p_operation_id
          AND CASE r.resource_type
                WHEN 'client_certificate' THEN
                  ...
                  operation -> 'authorizedCapabilities' -> 'signing' ->> 'keyBinding' = p_logical_binding_id
                WHEN 'secret' THEN
