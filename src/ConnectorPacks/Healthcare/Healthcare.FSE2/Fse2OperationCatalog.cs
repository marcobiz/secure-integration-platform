...
public static class Fse2OperationCatalog
{
    ...
    private static readonly FrozenDictionary<Fse2Operation, Fse2OperationDescriptor> Descriptors =
        new Dictionary<Fse2Operation, Fse2OperationDescriptor>
        {
            ...
            [Fse2Operation.GetStatusByWorkflow] = Descriptor(Fse2Operation.GetStatusByWorkflow, "get-status-by-workflow", HttpMethod.Get, "/status/{workflow-instance-id}", Fse2OperationAvailability.ProductionAvailable, null, null, false, false, "workflow-instance-id", false, 200),
            [Fse2Operation.GetStatusByTrace] = Descriptor(Fse2Operation.GetStatusByTrace, "get-status-by-trace", HttpMethod.Get, "/status/search/{trace-id}", Fse2OperationAvailability.ProductionAvailable, null, null, false, false, "trace-id", false, 200)
        }.ToFrozenDictionary();
