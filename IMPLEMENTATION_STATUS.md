...
| FSE2 local no-cloud provider lab | Remediation P1-01…P1-04/P2-01…P2-03 implementata; full exact-head gate e CI pending | Pack opzionale senza secret retrieval; chain/manifest/P12 rivalidati a ogni uso privato (provider 30/30); path/CSR triple-binding/ACL/cleanup fail-closed; validator Compose unico e active lab non-root/read-only con firma, certificato, tamper ready 503, stop degradato/partial e zero residui PASS. Fixture soltanto sintetiche; nessun materiale reale consultato/importato e nessuna call live |
