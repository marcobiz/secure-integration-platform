...
Updated: 2026-09-07
Baseline integrated through PR #71:
`de743638a03dcb5b0166a6a7f82285e01f6377e6`.
PR #70 integrated application credential adoption; PR #71 consolidated the bounded
audit/cache/onboarding implementations and canonical test execution. The current
Admin changes fix first-session entry, provide responsive layout and explicit UTC
dates, and bundle the authenticated operator guide. Preview verification is not
public-alpha release qualification.
