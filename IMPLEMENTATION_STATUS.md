...
| Wave 1 — Generic opaque-session HTTP projection | Local product gate PASS; CI exact-head e independent review pending | 22 nuovi casi mirati PASS; 283 suite ordinaria (273 PASS, 10 PG conditional), 11/11 PostgreSQL 18 PASS; placement tipizzato, policy server-owned, one-shot `RestrictedTransport`, race zero-dispatch e HTTPS sintetico reale |
