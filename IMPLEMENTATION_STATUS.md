...
| M6 — auth HTTP/OAuth primitives | Implementato; CI PASS, review indipendente pending | PR #9 sul product commit `29c99cf`: 21/21 job PASS; AP-02 challenge mechanics, AP-03 Authorization Code baseline e AP-04 bearer/cache/refresh sintetici; nessun connector sanitario production |
