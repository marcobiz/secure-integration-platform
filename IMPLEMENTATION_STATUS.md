...
| Wave 1 — Typed SOAP session handshake + authorized external admission | Gate locale e Core export PASS; CI exact-head in rerun dopo runtime-contract remediation; review indipendente pending | profilo Published four-eyes, adapter compilati, XML boundary hardened, intent opachi single-use nella cache M6 e promozione atomica post-validazione; 434 ordinary (423 PASS, 11 PG conditional), PostgreSQL 18 105/105, scan/SBOM/vulnerability/Core export PASS |
...
- evidenza locale: 27 unit typed, 2 integration HTTPS reali, 34 unit SOAP legacy/config, 5 integration SOAP legacy e 24 architecture PASS; suite ordinaria 434 totali (423 PASS, 11 PostgreSQL conditional), PostgreSQL 18 105/105, build Release senza warning/errori, document validation, secret scan, SBOM e vulnerability scan PASS. Core export completo PASS sul product commit `9f77cacaae294bb756b72413392825fcbdf9d230` (377 file, manifest SHA-256 `CFC83868E97A52F290C0E54D5A3DA553745BB1307F9107909EEFED32FEEA4A54`); CI exact-head e review indipendente restano da qualificare prima di qualsiasi GO di pubblicazione;
