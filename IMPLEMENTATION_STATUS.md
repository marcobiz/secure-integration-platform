...
| Healthcare Wave 1 - Sistema TS ePrescription | **NO-GO; hard stop documentale** | fonti ufficiali correnti WSDL/XSD/MFA/RBE congelate; manca la primitive server-owned per `Authorization2F` HTTP, nessun connector nazionale o synthetic server Sistema TS implementato |
