...
| M5 — Admin UI MVP | **Seven-finding acceptance remediation locally PASS; final read-only review pending** | product candidate `668e2266613ffa256a6759d5910520a5200e7cc1`; exact-head CI pending; PR #5 aperta/non unita; main invariato a `49f81cb37dcd5bf8956638fe4af53c3c5cf39b2b` |
...
- Migration additive fino a `0009_runtime_locator_resolution_m5.sql` SHA-256 `92D2A5826CF348C676EB619C8A75F5F267C0C15E074617DDD700B885324A80F1`; catalogo metadata e locator fisico sono separati. Il runtime non può enumerare la tabella locator e usa una funzione `SECURITY DEFINER` stretta, con owner `NOLOGIN`, `search_path` fisso e grant limitato. Trigger e privilegi colonnari continuano a impedire tamper delle revisioni binding Active/Approved. Pool amministrativo separato dal runtime.
- Container non-root include asset hashati/CSP nonce; quickstart locale usa PostgreSQL 18 e Synthetic Provider senza cloud.
- Seven-finding acceptance remediation sul candidate `668e2266613ffa256a6759d5910520a5200e7cc1`: artefatto approval completo e canonico; locator least-privilege; cache risorsa invalidata per invocation; anti-esfiltrazione integrata; conflict Application comprensivo di status/disable; runtime i18n generato dal contratto; browser mock deterministici. Tenant FORCE RLS resta invariato e verde. La regressione M4 emersa nella CI è corretta mantenendo distinti pool e credenziali DB admin/runtime senza riallargare i privilegi locator. Gate locale: 159 test .NET ordinari PASS, PostgreSQL 18 dedicato 10/10 PASS, 28 Vitest, browser-mock 360/360 a retry zero, quickstart M4 e FULLSTACK-01 PASS. La CI exact-head e la review read-only restano richieste: M5 non è Done e PR #5 non viene unita automaticamente. Dettagli in `docs/reviews/M5-FINAL-ACCEPTANCE-FIXES.md`.
