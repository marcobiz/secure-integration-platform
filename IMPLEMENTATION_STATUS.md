...
| Wave 1 — Typed SOAP session handshake + authorized external admission | Gate locale, Core export e CI product-head PASS; commit documentale conclusivo in riqualifica, review indipendente pending | PR #23 product commit `3260f385ec5d76a0f35528b2340d8d5ece573540`: 21/21 CI PASS; profilo Published four-eyes, adapter compilati, XML boundary hardened, intent single-use nella cache M6; 434 ordinary, PostgreSQL 18 105/105, scan/SBOM/vulnerability/Core export PASS |
...
- evidenza locale: 27 unit typed, 2 integration HTTPS reali, 34 unit SOAP legacy/config, 5 integration SOAP legacy e 24 architecture PASS; suite ordinaria 434 totali (423 PASS, 11 PostgreSQL conditional), PostgreSQL 18 105/105, build Release senza warning/errori, document validation, secret scan, SBOM e vulnerability scan PASS. Core export completo PASS sul product commit `3260f385ec5d76a0f35528b2340d8d5ece573540` (377 file, manifest SHA-256 `D37B2E745107F7D42479EDB8623DD36A3497569ED233A9289E3DBE4517788730`); PR #23 CI product-head 21/21 PASS nei run `31309002108` e `31309002106`. Il commit documentale conclusivo deve conservare verdi i check exact-head; review indipendente e merge restano separati;
