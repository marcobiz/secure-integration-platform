...
| M6 — auth HTTP/OAuth primitives | Candidate locale; CI e review indipendente pending | AP-02 challenge mechanics, AP-03 Authorization Code baseline e AP-04 bearer/cache/refresh sintetici; nessun connector sanitario production |
