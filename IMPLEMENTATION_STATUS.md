...
| M5 — Admin UI MVP | **Final remediation candidate; review read-only richiesta** | implementation HEAD `080ae20f11070382084a1c66c210129f9a309609`; CI `31048418560` (6/6) e `31048413797`/`31048418026` (15/15 ciascuna) PASS; PR #5 aperta/non unita; main invariato a `49f81cb37dcd5bf8956638fe4af53c3c5cf39b2b` |
...
- Remediation sul candidate `080ae20f11070382084a1c66c210129f9a309609`: 145 test .NET ordinari PASS e 7 PostgreSQL SKIP espliciti; PostgreSQL 18 dedicato 8/8 PASS con principal amministrativo non-superuser e identità migration separata; 22 Vitest, 32 browser-mock e FULLSTACK-01 PASS. Il full-stack importa/pubblica `2.0.0`, usa l'Installation realmente iscritta, attraversa runtime BGW1+mTLS, Vault sintetico e vendor mock, correla l'audit e nega dopo retire. CI generale `31048418560` (6/6), M5 push `31048413797` (15/15) e M5 PR `31048418026` (15/15) sono PASS. La review read-only resta richiesta: M5 non è Done e PR #5 non viene unita automaticamente.
