...
| Wave 1 — Typed SOAP session handshake + authorized external admission | Remediation mirata dei 7 finding: gate locale e Core export PASS; CI exact-head e targeted re-review pending | PR #23 product commit `45605a9fb3085d83af3b2d9d50e8b08f4a987f65`: validation transport Core-owned, presentation autenticata reference-only, mutation lease/CAS linearizzabile, production wiring; 453 ordinary, PostgreSQL 18 109/109, Admin/full-stack, scan/SBOM/vulnerability/Core export PASS |
...
- evidenza remediation: 41 unit typed, 4 integration HTTPS typed, 1 API typed, 35 unit SOAP legacy/config, 5 integration SOAP legacy e 24 architecture PASS; suite ordinaria 453 totali (441 PASS, 12 PostgreSQL conditional), PostgreSQL 18 109/109, Admin 28 unit + 37 UI mock + 2 a11y + full-stack, build Release zero warning/errori, document validation, secret scan, SBOM e vulnerability scan PASS. Core export PASS sul product commit `45605a9fb3085d83af3b2d9d50e8b08f4a987f65` (380 file, manifest SHA-256 `FD2CCA693FE181D51A7FFA8110A1BCADACA156EFA5DB0AE14929AFDDC31C398A`); exact-head CI del commit documentale e targeted re-review pending, merge non autorizzato;
