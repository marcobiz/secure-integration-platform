...
| Healthcare Wave 1 — FSE2 National Connector | **BLOCKED_BY_TRUSTED_ACTOR_SOURCE** | Freeze 2.23/OpenAPI 1.0.0 ancora corrente al commit ufficiale `430e6b5`; i gap generic Core sono chiusi sulla baseline `705e9d4`, ma il prodotto non ha una sorgente server-side autorevole per CF/organizzazione dell'attore sanitario. Nessun input business è stato promosso a `sub`; vedere `docs/testing/FSE2-RESUME-GATE-REPORT.md`. |
