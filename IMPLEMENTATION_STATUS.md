...
| M5 — Admin UI MVP | **Final remediation candidate; review read-only richiesta** | implementation HEAD `9eea56f632bcf20e0eb8f0bec438796d36097eed`; PR #5 aperta/non unita; main invariato a `49f81cb37dcd5bf8956638fe4af53c3c5cf39b2b` |
...
- Remediation locale sul candidate `9eea56f632bcf20e0eb8f0bec438796d36097eed`: 144 test .NET ordinari PASS e 7 PostgreSQL SKIP espliciti; PostgreSQL 18 dedicato 8/8 PASS; 22 Vitest, 32 browser-mock e FULLSTACK-01 PASS. Il full-stack importa/pubblica `2.0.0`, usa l'Installation realmente iscritta, attraversa runtime BGW1+mTLS, Vault sintetico e vendor mock, correla l'audit e nega dopo retire. Evidence finale e CI della PR sono ancora da finalizzare; M5 non è Done e PR #5 non viene unita automaticamente.
