...
| M5 — Admin UI MVP | **Final remediation candidate; review read-only richiesta** | implementation HEAD `9065d627ca3e70f9d4e56dd8a32d5aa0192735ff`; CI `31049726466` (6/6) e `31049725534`/`31049726550` (15/15 ciascuna) PASS; PR #5 aperta/non unita; main invariato a `49f81cb37dcd5bf8956638fe4af53c3c5cf39b2b` |
...
- Migration additive fino a `0007_binding_bundle_immutability_m5.sql` SHA-256 `EC3B4E9A85FB050A1FDFC16E4E7B89042A7A6D93972CA46DF2BCEA2AE51FEE4A`; trigger e privilegi colonnari impediscono tamper delle revisioni binding Active/Approved. Pool amministrativo separato dal runtime.
- Container non-root include asset hashati/CSP nonce; quickstart locale usa PostgreSQL 18 e Synthetic Provider senza cloud.
- Remediation sul candidate `9065d627ca3e70f9d4e56dd8a32d5aa0192735ff`: 145 test .NET ordinari PASS e 7 PostgreSQL SKIP espliciti; PostgreSQL 18 dedicato 8/8 PASS con principal amministrativo non-superuser e identità migration separata; 22 Vitest, 32 browser-mock e FULLSTACK-01 PASS. Il full-stack importa/pubblica `2.0.0`, usa l'Installation realmente iscritta, attraversa runtime BGW1+mTLS, Vault sintetico e vendor mock, correla l'audit e nega dopo retire. La race fra pubblicazione e modifica dei binding è atomica in entrambi gli ordini serializzabili e gli abort PostgreSQL sono normalizzati in `BGW-CONCURRENCY-CONFLICT`. CI generale `31049726466` (6/6), M5 push `31049725534` (15/15) e M5 PR `31049726550` (15/15) sono PASS sullo SHA esatto. La review read-only resta richiesta: M5 non è Done e PR #5 non viene unita automaticamente.
