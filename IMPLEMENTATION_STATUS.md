...
| Wave 1 — Typed SOAP session handshake + authorized external admission | Gate locale e Core export PASS; CI exact-head e review indipendente pending | profilo Published four-eyes, adapter compilati, XML boundary hardened, intent opachi single-use nella cache M6 e promozione atomica post-validazione; 434 ordinary (423 PASS, 11 PG conditional), PostgreSQL 18 105/105, scan/SBOM/vulnerability/Core export PASS |
