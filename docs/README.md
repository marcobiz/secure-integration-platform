...
26. [FSE2 Wave 1 - freeze ufficiale e gate risolto](implementation/FSE2-WAVE1-SPEC-FREEZE.md), [profilo organizzativo](connectors/healthcare/fse2/README.md) e [report di implementazione](testing/FSE2-IMPLEMENTATION-REPORT.md)
