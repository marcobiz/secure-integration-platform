...
| Production composition, real authorization/store/four-eyes and server-side completion resolution | successful restricted-HTTPS E2E; `Wave1_IT_Production_runtime_denies_adapter_version_endpoint_and_resource_authority_changes_before_validation_network`; `Wave1_IT_DAT_PostgreSQL18_typed_session_four_eyes_publication_and_runtime_locator_resolution_when_configured`; `Wave1_IT_GTW_Typed_session_routes_require_authenticated_principal_and_never_echo_candidate` | PASS local and PostgreSQL 18 |
