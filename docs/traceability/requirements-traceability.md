...
| Frozen validate-cda case 476 contract | Dataset commit `d937255fd7e9c079c5641c537da17fe98a2f2259`: XML `Test Case/Validazione/Documenti XML Casi OK/8 - Casi OK Profilo Sanitario Sintetico/PSS476.xml`, blob `6b654344431a21e02b979ab4907bc53b38cb4143`, 58,712 bytes, SHA-256 `7B54299D5AD7E87CA7D5569E98ADAC2D687D3E9432FD4D015194E733A2ADAABD`; PDF `GATEWAY/A1#111#DAVINCI.CARE/DaVinci Healthcare/DaVinci/3.3/FILES/PSS476.pdf`, blob `a4bf835cbf08661a6c530f95bdea1770e0ca4ad0`, 60,148 bytes, SHA-256 `129BE437228376B897B8D176DE099CA165714901DA3CB7B78EE2F9B68F4A252E`. Checklist row 476 identifies `VALIDAZIONE_CDA2_PSS_CT23`; among the named candidates this PDF alone embeds `cda.xml` byte-identical to PSS476.xml. Exact PDF bytes cross `Fse2Request` and observed multipart `file`; requestBody is `VERIFICA`/`CDA`/`ATTACHMENT`, `attachment_hash` absent, mock request count one. | PASS offline exact-PDF T03 gate; OfficialTest DNS/network zero |
