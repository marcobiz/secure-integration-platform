...
- Leaf, chain, fingerprint, SPKI e versione sono vincolati nel manifest. I P12 vengono caricati
  ...
  operazioni di firma bounded. Non esiste export della chiave privata.
...
- L'importer è offline e fail-closed. La modalità predefinita effettua solo correlazione, trust e
  ruolo; la creazione richiede `-Execute`, fingerprint attese out-of-band e una directory nuova
  esterna al repository. Produce password casuali indipendenti e ACL ristrette.
...
Administrator/SYSTEM e un operatore con accesso alla directory esterna restano nella TCB. Un bind
...
SPKI; una sostituzione privilegiata tra controllo e lettura rimane rischio residuo del laboratorio.
